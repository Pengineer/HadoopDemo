...
public class DBConfiguration {
  ...
  public static final String URL_PROPERTY = "jdbc:oracle:thin:@192.168.88.176:1521:orcl";

  /** User name to access the database */
  public static final String USERNAME_PROPERTY = "scott";
  
  /** Password to access the database */
  public static final String PASSWORD_PROPERTY = "peng123";
